...
const file_order_proto_rawDesc = "" +
	...
	"\x05items\x18\x04 \x03(\v2\x10.order.OrderItemR\x05items\"U\n" +
	...
	"\x05order\x18\x02 \x01(\v2\f.order.OrderR\x05order\"1\n" +
...
var file_order_proto_depIdxs = []int32{
	...
	1, // 3: order.UpdateOrderStatusResponse.order:type_name -> order.Order
	1, // 4: order.GetOrdersByUserResponse.orders:type_name -> order.Order
